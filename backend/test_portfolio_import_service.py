...
class PortfolioImportServiceHelpersTestCase(unittest.TestCase):
    def test_try_parse_float_supports_common_import_formats(self):
        ...
        self.assertEqual(PortfolioImportService._try_parse_float('PLN 1.234,56'), 1234.56)
        self.assertEqual(PortfolioImportService._try_parse_float("1'234.56 USD"), 1234.56)
